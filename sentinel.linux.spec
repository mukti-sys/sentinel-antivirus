...
"""PyInstaller Multi-Binary Specification for Sentinel Antivirus — Linux Build.

Builds 3 native ELF executables sharing a unified dependency bundle:
  1. sentinel_service  : Background daemon (runs via systemd)
...
# Core hidden imports — Linux build (no win32 modules)
hidden_imports = [
    "lightgbm",
    "pyarrow",
    "pyarrow.parquet",
    ...
    "sentinel.sensors.audit_sensor",
    "sentinel.sensors.journald_sensor",
    "sentinel.sensors.fanotify_sensor",
    "sentinel.service",
